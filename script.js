var scenes = [`airportscene`, `beachscene`, `cityStreetscene`, `cruisescene`, `desertscene`, `grandCentralscene`, `officescene`, `pondscene`, `poolscene`, `shipscene`]
// var scenes = [`fashionshowscene`]
var score = 0
...
// var fashionshowscene = document.getElementById('fashionshow')
...
function changeScene() {
    ...
    // else if (nextScene == "fashionshowscene") {
    //     newFound = true
    ...
    //     words.setAttribute("color", "pink")
    //     scenes.splice(scenes.indexOf(`fashionshowscene`), 1)
    //     newFound = false
    // }
    ...
    if (scenes.length < 1) {
        scenes = [`airportscene`, `beachscene`, `cityStreetscene`, `cruisescene`, `desertscene`, `grandCentralscene`, `officescene`, `pondscene`, `poolscene`, `shipscene`]
    }
}
...
function reset() {
    ...
    // fashionshowscene.setAttribute("visible", "false")
    camerapos.setAttribute("position", "0 0 0")
    for (var i = 0; i < scorePrint.length; i++) {
        scorePrint[i].setAttribute("value", " ")
    }
}
